...
/**
 * Provider implementation for the Verkehrsverbund Ost-Region (Vienna, Lower Austria and Burgenland, Austria).
 */
public class VorProvider extends VaoProvider {
    private static final HttpUrl API_BASE = HttpUrl.parse("https://anachb.vor.at/hamm/");
    private static final String DEFAULT_API_CLIENT = "{\"id\":\"VAO\",\"type\":\"WEB\",\"name\":\"webapp\",\"l\":\"vs_anachb\"}";
    private static final String WEBAPP_CONFIG_URL = "https://anachb.vor.at/webapp/config/webapp.config.json";
