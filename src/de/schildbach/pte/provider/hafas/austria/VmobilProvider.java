 ...
 */
public class VmobilProvider extends VaoProvider {
    private static final HttpUrl API_BASE = HttpUrl.parse("https://fahrplan.vmobil.at/hamm/");
    private static final String DEFAULT_API_CLIENT = "{\"id\":\"VAO\",\"type\":\"WEB\",\"name\":\"webapp\",\"l\":\"vs_vvv\"}";
    private static final String WEBAPP_CONFIG_URL = "https://fahrplan.vmobil.at/webapp/config/webapp.config.json";
    ...
    public VmobilProvider(final String apiClient, final String apiAuthorization) {
        super(NetworkId.VMOBIL, API_BASE, apiClient, apiAuthorization);
    }
}
