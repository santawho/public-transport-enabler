...
public class TransitousProviderLiveTest extends AbstractProviderLiveTest {
    ...
    public void nearbyStationsByCoordinate() throws Exception {
        final NearbyLocationsResult result = queryNearbyStations(new Location(LocationType.COORD, null, Point.from1E6(50767803, 6091504)));
        print(result);
    }

    @Test
    public void queryDepartures() throws Exception {
        final QueryDeparturesResult result = queryDepartures("de-DELFI_de:05315:11211:1:11", NetworkProvider.EquivalentStationsMode.KEEP_DISTINCT);
    ...
    public void queryDeparturesInvalidStation() throws Exception {
        final QueryDeparturesResult result = queryDepartures("999999", NetworkProvider.EquivalentStationsMode.KEEP_DISTINCT);
    ...
    public void tripBetweenCoordinates() throws Exception {
        final Location from = new Location(LocationType.COORD, null, Point.from1E6(50767803, 6091504)); // Aachen Hbf
        final Location to = new Location(LocationType.COORD, null, Point.from1E6(50769870, 6073840)); // Aachen, Schanz
        final QueryTripsResult result = queryTrips(from, null, to, new Date(), true, null);
        print(result);
    }
}
